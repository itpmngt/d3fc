...
export default () => {
    ...
    const project = (elementCount, verticesPerElement) => {
        ...
        // TODO: optimise allocation - we can reuse the array if the data fits & type stays the same
        // TODO: float32 isn't appropriate for other types
    ...
    const build = (
        ...
        // TODO: this doesn't cover any of the rebound properties changing
        if (validSize >= count) {
            return;
        }
